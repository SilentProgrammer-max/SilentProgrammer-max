...
.coding-girl-img:hover {
  transform: scale(1.05);
  background-color: rgb(14, 43, 104); /* slightly dark background */
  box-shadow: 0 0 20px rgba(0, 117, 98, 0.12);
  cursor: pointer;
}
.code-glow {
...
.code-glow:hover {
  ...
  cursor: pointer;
    ...
    .icon-container img:hover {
      transform: scale(1.1);
      filter: blur(0px) drop-shadow(0 0px 10px rgba(0, 255, 213, 0.23));
    }
.card {
...
.card:hover {
  ...
  filter: drop-shadow(0 0 12px rgba(102, 119, 116, 0.2));
}
